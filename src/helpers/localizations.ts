...
P.S.: si vols contribuir al desenvolupament d'aquest bot, per favor, fes un donatiu mitjançant el programa de patrocinadors GitHub que trobaràs [aquí](https://github.com/sponsors/backmeupplz).`,
    sc: `Shieldy — est sa mègius solutzione in Telegram pro cumbàtere sos ispammadores infadosos. Pedit a sos arribbados noos de fàghere un’atzione intre unu perìodu dislindadu, ca si nono los bogat a foras. Est gasi fàtzile. Assegura·ti chi @shieldy\\_bot siat un’amministradore in sa tzarrada tua e est totu fatu| Podes fintzas cunfigurare galu de prus su cumportamentu suo cun custos cumandos:

/help — mustrat custu messàgiu
/language — mudat sa limba
/captcha — mudat sa genia de captcha impreadu
/timeLimit — mudat sa candidade de tempus frunidu a sos arribbados noos
/lock — faghet in menara chi sos cumandos siant atzessìbiles petzi a sos amministradores
/restrict — lìmitat sos arribados noos in manera chi potzant petzi imbiare messàgios de testu in sas primas 24 oras
/deleteEntryMessages — iscantzellat sos messàgios subra de s’intrada de utentes
/greeting — dat su benebènnidu a sos utentes chi colant sa proa
/trust — risponde cun custu cumandu a unu messàgiu imbiadu dae un’utente chi non boles verificare
/ban — su matessi de trust, ma a s’imbesse
/strict — imprea·lu cando non boles retzire perunu messàgiu dae sos arribbados noos francu sas solutziones a sos captcha finas a cando non passant su captcha
/customCaptchaMessage — cunfigura unu messàgiu captcha personalizadu
/deleteGreetingTime — imposta cando iscantzellare su benebènnidu de Shieldy's in segundos, a tipu \`/deleteGreetingTime 100\`, reseta·lu pondende·bi 0
/banUsers — si bandire o bogare a foras sos utentes
/deleteEntryOnKick — si iscantzellare sos messàgios de intrada pro sos utentes chi fallint su captcha
/cas — si impreare s’Anti-Spam Combot o nono
/underAttack — ativa o disativa sa modalidade pro bogare a foras in automàticu totu sos arribbados noos
/noAttack — inabìlitat Shieldy
/noChannelLinks — iscantzellat sos messàgios chi tenent ligàmenes a àteros canales de Telegram
/viewConfig — pòmpia sa cunfiguratzione atuale de Shieldy
/buttonText — mudat su testu de su butone de su captcha in sa forma \`/buttonText I'm not a bot!\`
/allowInvitingBots — si sos utentes podent invitare àteros bots o nono
/greetingButtons — cunfigura sos butones pro su messàgiu de benebènnidu

Tenes galu preguntas? Bae a su canale de suportu — @borodutch\\_support. Su còdighe de Shieldy est abertu e si podet agatare [inoghe](https://github.com/backmeupplz/shieldy). Gràtzias!

Pòmpia·ti fintzas un’àteru de sos progetos meos — [Todorant](https://todorant.com) ([iOS](https://apps.apple.com/us/app/todorant/id1482078243), [Android](https://play.google.com/store/apps/details?id=com.todorant)). Est un’aplicatzione pro listas inteligentes de cosas de fàghere chi impreat sa psicologia cognitiva pro trampare su cherbeddu tuo pro li fàghere acabbare progetos e ammustrare resurtados. Est de badas pro 30 dies chene clàusola peruna, duncas bae e proa·lu si boles megiorare sa produtividade tua. M’at agiudadu — Podet agiudare fintzas a tie.`,
  ...
  language: {
	...
	sc: "Pro praghere issèbera sa limba",
  },
  language_selected: {
	...
	sc: 'Bene meda, como chistiono su sardu.',
  },
  only_author_can_reply: {
	...
	sc: 'Petzi sa persone chi at aviadu su menù podet seletzionare sos issèberos.',
  },
  captcha: {
...
• Imatge — el bot et demanarà que reconeguies els caracters d'una imatge`,
    sc: `Pro praghere seletziona sa casta de proa pro sos arribbados noos:

• Simpre — su bot at a pedire de imbiare una cosa cale si siat a sa tzarrada
• Butone — su bot at a pedire de incarcare unu butone
• Tzifras — su bot at a pedire de risòlvere un’operatzione matemàtica simpre
• Immàgine — su bot at a pedire de reconnòschere sos caràteres in un’immàgine`,
  },
  simple: {
    en: 'Simple',
    ru: 'Простая',
  ...
  captcha_selected: {
	...
	sc: 'Bene meda, tando apo a impreare custa casta de proa.',
  },
  time_limit: {
    en:
	...
	sc:
      'Pro praghere issèbera cantos segundos sos arribbados noos ant a tènnere pro cumpletare sa proa prima in antis de èssere bogados a foras.',
  },
  time_limit_selected: {
	...
	sc: 'Bene meda, tando apo a impreare custu lìmite de tempus.',
  },
  seconds: {
    en: 'sec',
    ru: 'сек',
  ...
  lock_true: {
	...
	sc: 'Bene meda! Como apo a regire petzi a sos cumandos imbiados dae sos amministradores.',
  },
  lock_false: {
	...
	sc: 'Bene meda! Como apo a reagire a sos cumandos imbiados dae totus.',
  },
  strict_true: {
    en:
	...
	sc:
      "Bene meda! Como sos arribbados noos no ant a imbiare nudda francu solutziones de sos captcha finas a cando no ant a risòlvere su captcha.",
  },
  strict_false: {
    en:
	...
	sc:
      'Bene meda! Como sos arribbados noos ant a pòdere imbiare testos in antis de àere risòlvidu su captcha.',
  },
  simple_warning: {
    en:
	...
	sc:
      ', pro praghere imbia unu messàgiu a custu grupu intro de su lìmite de tempus ispetzificadu, si nono as a èssere bogadu a foras. Gràtzias!',
  },
  digits_warning: {
    en:
	...
	sc:
      ', pro praghere imbia sa solutzione a s’operatzione aritmètica frunida intro de su lìmite de tempus ispetzificadu, si nono as a èssere bogadu a foras. Gràtzias!',
  },
  button_warning: {
    en:
	...
	sc:
      ', pro praghere incarca su butone inoghe in suta intro de su lìmite de tempus ispetzificadu, si nono as a èssere bogadu a foras. Gràtzias!',
  },
  image_warning: {
    en:
	...
	sc:
      ", pro praghere imbia sos caràteres ammustrados intro de su lìmite de tempus ispetzificadu, si nono as a èssere bogadu a foras. Gràtzias!",
  },
  captcha_button: {
    en: 'I am not a bot',
    ru: 'Я не бот',
  ...
  only_candidate_can_reply: {
	...
	sc: 'Petzi su candidadu pro no èssere unu bot podet incarcare custu butone.',
  },
  restrict_true: {
    en:
	...
	sc:
      'Bene meda! Como totu sos arribbados noos ant a pòdere petzi imbiare messàgios usuales de testu a custa tzarrada.',
  },
  restrict_false: {
    en:
	...
	sc:
      'Bene meda! Como totu sos arribbados noos ant a pòdere imbiare cale si siat genia de cuntenutu a custa tzarrada.',
  },
  deleteEntryMessages_true: {
	...
	sc: 'Bene meda! Como sos messàgios de intrada s’ant a iscantzellare.',
  },
  deleteEntryMessages_false: {
	...
	sc: 'Bene meda! Como sos messàgios de intrada non s’ant a iscantzellare.',
  },
  greetsUsers_true: {
    en:
	...
	sc:
      'Bene meda! Como sos arribbados noos chi ant coladu sa proa ant a retzire su benebènnidu. Risponde a custu messàgiu cun su testu de benebènnidu chi dias chèrrere impreare (podes impreare sas funtziones $title, $fullname e $username).',
  },
  greetsUsers_true_message: {
	...
	sc:
      'Bene meda! Como sos arribbados noos chi ant coladu sa proa ant a retzire su benebènnidu. Risponde a custu messàgiu cun su testu de benebènnidu chi dias chèrrere impreare (podes impreare sas funtziones $title, $fullname e $username). Su messàgiu de benebènnidu atuale est su chi sighit.',
  },
  greetsUsers_false: {
	...
	sc: 'Bene meda! Como sos arribbados noos chi ant coladu sa proa no ant a retzire su benebènnidu.',
  },
  ...
  captchaMessage_true: {
	...
	sc:
      'Bene meda! Como sos arribados noos ant a retzire messàgios personalizados chi ispiegant su captcha. Risponde a custu messàgiu cun su testu de su captcha chi dias chèrrere impreare (podes impreare sas funtziones $title, $username, $equation, $fullname e $seconds).',
  },
  captchaMessage_true_message: {
	...
	sc:
      'Bene meda! Como sos arribados noos ant a retzire messàgios personalizados chi ispiegant su captcha. Risponde a custu messàgiu cun su testu de su captcha chi dias chèrrere impreare (podes impreare sas funtziones $title, $username, $equation, $fullname e $seconds). Su messàgiu de benebènnidu atuale est su chi sighit.',
  },
  captchaMessage_false: {
	...
	sc: 'Bene meda! Como sos arribados noos ant a bìdere su messàgiu de captcha predefinidu',
  },
  trust_success: {
    en: 'Accepted!',
    ru: 'Принято!',
  ...
  banUsers_true: {
	...
	sc: 'Bene! Sos utentes ant a èssere bandidos si no ant a risòlvere su captcha.',
  },
  banUsers_false: {
	...
	sc: 'Bene! Sos utentes ant a èssere bogados a fora si no ant a risòlvere su captcha.',
  },
  deleteEntryOnKick_true: {
	...
	sc:
      'Bene meda! Shieldy at a bogare sos messàgios de intrada de sos utentes chi ant fallidu su captcha.',
  },
  deleteEntryOnKick_false: {
	...
	sc:
      'Bene meda! Shieldy no at a bogare sos messàgios de intrada de sos utentes chi ant fallidu su captcha.',
  },
  cas_true: {
	...
	sc: 'Bene meda! Shieldy como at a impreare Combot Anti-Spam.',
  },
  cas_false: {
	...
	sc: 'Bene meda! Shieldy como no at a impreare Combot Anti-Spam.',
  },
  underAttack_true: {
    en:
	...
	sc:
      "Bene meda! Shieldy como at a bogare a foras totu sos chi ant a intrare in custa tzarrada. Non t’ismèntighes de istudare custa modalidade cando s’atacu est agabbadu cun /underAttack.",
  },
  underAttack_false: {
	...
	sc: 'Bene meda! Shieldy como no at a bogare totu sos chi ant a intrare in custa tzarrada.',
  },
  noAttack_true: {
    en:
	...
	sc:
      "Bene meda! Shieldy como est disabilitadu. Non t'ismèntighes de istudare custa modalidade cun /noAttack.",
  },
  noAttack_false: {
	...
	sc: 'Bene meda! Shieldy como est allutu.',
  },
  noChannelLinks_true: {
    en:
	...
	sc:
      'Bene meda! Shieldy como at a iscantzellare sos messàgios chi tenent ligàmenes a canales de Telegram.',
  },
  noChannelLinks_false: {
	...
	sc:
      'Bene meda! Shieldy no at a iscantzellare sos messàgios chi tenent ligàmenes a canales de Telegram.',
  },
  viewConfig: {
    en: 'Current config:',
  ...
  allowInvitingBots_true: {
	...
	sc: 'Bene! Sos utentes como podent invitare sos bots.',
  },
  allowInvitingBots_false: {
	...
	sc: 'Bene! Sos utentes como non podent invitare sos bots.',
  },
  greetingButtons: {
...
Aquests són els botons que tens configurats actualment:`,
    sc: `Risponde a custu messàgiu (e so narende risponde(!), no imbies petzi un’àteru messàgiu) cun finas a 10 ligàmenes in su formadu inoghe in suta pro cunfigurare sos butones de benebènnidu. Risponde cun cale si siat àtera cosa pro bogare totu sos butones.
