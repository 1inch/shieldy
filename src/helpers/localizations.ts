export const localizations = {
  ...
  strict_true: {
    ...
    uk:
      'Чудово! Тепер новачки не матимуть змоги надсилати у чат нічого, окрім вирішення капчі, поки її не розвʼяжуть.',
    tr:
