export const localizations = {
  helpShieldy: {
    en: "Make sure @shieldy\\_bot is an admin at your chat and it's all done! " +
      "You can also further setup the behaviour with the following commands:\n\n" +
      ...
      "to execute specific actions within a set period and, if they fail to do so, rejects them. " +
      "Originally created by Nikita Kolmogorov, Shieldy was later acquired by the 1inch Labs, which now " +
      "supports the bot: @borodutch\\_support.\n\nThe 1inch Network unites decentralized protocols whose synergy " +
      "enables the most lucrative, fastest and protected operations in the DeFi space.",
    ru: "Убедитесь, что @shieldy\\_bot — админ в вашей группе, и все уже готово! Вы можете продолжить настройку бота, воспользовавшись следующими командами:\n\n" +
      ...
      "Shieldy – инновационное решение для борьбы со спамом в Телеграме. Бот предлагает каждому новому " +
      "пользователю совершить несколько действий в заданный период и в противном случае отказывает им в " + 
      "доступе. Проект Shieldy был создан Никитой Колмогоровым, а затем приобретен 1inch Labs, " +
      "разработчиком протоколов 1inch Network. В настоящее время поддержкой бота: @borodutch\\_support " +
      "занимается 1inch Labs.\n\n1inch Network объединяет несколько децентрализованных протоколов, " +
      "синергия которых обеспечивает самые выгодные, быстрые и безопасные транзакции в индустрии DeFi.",
    it:
